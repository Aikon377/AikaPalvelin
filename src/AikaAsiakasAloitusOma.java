...
public class AikaAsiakasAloitusOma {
    ...
    public static void main(String[] args) {
        ...
        AikaAsiakasAloitusOma a = new AikaAsiakasAloitusOma();
        ...
        try {
            ...
            if (vastaus.startsWith("2")) {
                System.out.println("Ajansopiminen kÃ¤ynnistetty");
                    ...
                    out.print(AikaProto.A_SOPIVAT + " " + tunnus + " " + AikaProto.listToString(sopivaAika) + AikaProto.EOL);
                    out.flush();
